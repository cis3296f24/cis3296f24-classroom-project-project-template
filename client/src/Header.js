    ...
    <header className="bg-transparent">
      <nav className="mx-auto flex max-w-7xl items-center justify-between p-4 lg:px-8">
        <div className="flex lg:flex-1">
          <NavLink to="/" className="pixelify-sans-bold text-lg">
            <Lottie
            ...
            />
            <span style={{ position: "relative", top: "-10px" }}>GRINDDAILY</span>
          </NavLink>
        </div>
      ...
      <Dialog open={mobileMenuOpen} onClose={setMobileMenuOpen} className="lg:hidden">
        ...
        className="fixed inset-y-0 right-0 z-10 w-full overflow-y-auto bg-transparent px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-gray-900/10">
          <div className="flex items-center justify-between">
            <NavLink to="/" onClick={() => setMobileMenuOpen(false)} className="pixelify-sans-bold">
              GRINDDAILY
            </NavLink>
            <button
              type="button"
